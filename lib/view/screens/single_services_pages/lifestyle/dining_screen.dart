...
import 'package:abyansf_asfmanagment_app/view/screens/single_services_pages/single_life_style/single_dining_screen.dart';
          ...
          children: [
            Stack(
              children: [
                SizedBox(
                  ...
                  child: Image.asset(AssetPath.lifeStyle1,  fit: BoxFit.cover),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Venues', style: AppTextStyle.bold24),
                  const SizedBox(height: 12),
                  CarouselContainer(
                    imagePath: AssetPath.lifeStyle1,
                  ...
                  Text('Lunch', style: AppTextStyle.bold24),
                  const SizedBox(height: 12),
                  GestureDetector(
                    onTap: () {
                      Get.to(SingleDiningScreen());
                    },
                      ...
                      itemBuilder: (context, index, realIndex) {
                        return Padding(
                          ...
                          child: CarouselContainer(
                            ...
                            title: 'Exclusive Gourmet Experiences',
                            location: 'Jumeirah Beach Residence',
                            personIcon: AssetPath.personImage,
                            clockIcon: AssetPath.clockImage,
                          ),
