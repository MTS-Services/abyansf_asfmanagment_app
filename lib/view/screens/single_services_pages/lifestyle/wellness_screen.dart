...
import 'package:abyansf_asfmanagment_app/view/screens/single_services_pages/single_life_style/single_wellness_screen.dart';
...
AssetPath.lifeStyle1,
AssetPath.lifeStyle2,
AssetPath.lifeStyle3,
AssetPath.lifeStyle4,
  ];
          ...
          children: [
            Stack(
              children: [
                SizedBox(
                  ...
                  child: Image.asset(AssetPath.lifeStyle4, fit: BoxFit.cover),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Spa', style: AppTextStyle.bold24),
                  const SizedBox(height: 12),
                  CarouselContainer(
                    imagePath: AssetPath.lifeStyle4,
                    title: "Luxury Spas & Retreats",
                  ...
                  Text('Therapy', style: AppTextStyle.bold24),
                  const SizedBox(height: 12),
                  GestureDetector(
                    onTap: () {
                      Get.to(SingleWellnessScreen());
                    },
